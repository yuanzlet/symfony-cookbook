...
但是由于 Assetic 改变了你的资产的路径，这将会打乱所有的使用相对路径的背景图片(或者其它路径)，除非你使用了 [cssrewrite](http://symfony.com/doc/current/cookbook/assetic/asset_management.html#cookbook-assetic-cssrewrite) 过滤器。  
