...
为了帮助您完成这个，最后一个发布的副版本将会触发过期提醒。例如，2.7 和 2.8 版本触发过期提醒。当在浏览器的[开发环境](http://symfony.com/doc/current/cookbook/configuration/environments.html)上访问你的应用程序时，这些提醒会在 web 开发工具栏显示:
...
为了确保这样的情况不会发生，你可以安装 PHPUnit bridge：

```
$ composer require symfony/phpunit-bridge
```

现在，你的任务像通常一样执行，一个漂亮的过期提醒总结显示在测试报告末尾。
